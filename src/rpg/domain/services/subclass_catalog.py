...
CLASS_SUBCLASS_CATALOG: Mapping[str, Sequence[ClassSubclass]] = {
    ...
    "wizard": (
        ClassSubclass("crimson_spire", "School of Evocation", "Artillery casters shaping explosive fire and force."),
        ClassSubclass("alabaster_sanctum", "School of Abjuration", "Defensive ward scholars specializing in protective abjuration."),
        ClassSubclass("obsidian_cabal", "School of Necromancy", "Forbidden arcanists of shadow, death, and life-draining arts."),
        ClassSubclass("cobalt_ward", "School of Enchantment", "Arcane suppressors focused on containment and anti-magic control."),
        ClassSubclass("emerald_circle", "School of Transmutation", "Transmuters and conjurers of acid, poison, and nature-warping effects."),
        ClassSubclass("aurelian_order", "School of Divination", "Fate seers manipulating timing, probability, and foresight."),
        ClassSubclass("silver_conclave", "School of Conjuration", "Spatial scholars who summon allies and shape battlefield positioning."),
        ClassSubclass("veil_athenaeum", "School of Illusion", "Perception weavers bending sight, sound, and tactical misdirection."),
    ),
    "sorcerer": (
        ClassSubclass("crimson_pyreborn", "Inferno Pyreborn", "Innate volatile fire/force prodigy trained for destructive control."),
        ClassSubclass("alabaster_seraph", "Aegis Seraph", "Rare lawful-celestial bloodline adept at sanctioned restorative combat magic."),
        ClassSubclass("obsidian_umbralist", "Umbralist", "Natural channeler of gloom, deathly resonance, and umbral force."),
        ClassSubclass("cobalt_anomaly", "Arcflux Anomaly", "Unstable conduit of chaotic surges studied for containment."),
        ClassSubclass("emerald_beguiler", "Wildwood Beguiler", "Fae-tinged manipulator blending beguilement with toxic power."),
        ClassSubclass("aurelian_fate_weaver", "Fate-Weaver Scion", "Innately linked to cosmic order, luck, and temporal drift."),
    ),
}
