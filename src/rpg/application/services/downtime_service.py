...
class DowntimeService:
    _ACTIVITIES: tuple[DowntimeActivity, ...] = (
        ...
        DowntimeActivity(
            id="brew_antitoxin",
            title="Brew: Antitoxin",
            description="Distill counteragents from bitter roots and fungus.",
            days=1,
            gold_cost=5,
            inventory_rewards=("Antitoxin",),
            reputation_deltas={"tower_aurelian": 1},
            activity_family="crafting",
        ),
        DowntimeActivity(
            id="forge_travel_kit",
            title="Forge: Travel Kit",
            description="Assemble a reinforced utility bundle for rough routes.",
            days=1,
            gold_cost=5,
            inventory_rewards=("Sturdy Rations", "Rope"),
            activity_family="crafting",
        ),
        DowntimeActivity(
            id="carouse_contacts",
